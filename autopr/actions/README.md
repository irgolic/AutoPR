...
### [`__init__.py`](https://github.com/irgolic/AutoPR/blob/50cfaeeaaedc4a6529b5a363ba237dce1404ad03/./autopr/actions/__init__.py)
...
### [`base.py`](https://github.com/irgolic/AutoPR/blob/50cfaeeaaedc4a6529b5a363ba237dce1404ad03/./autopr/actions/base.py)
...
### [`bash.py`](https://github.com/irgolic/AutoPR/blob/50cfaeeaaedc4a6529b5a363ba237dce1404ad03/./autopr/actions/bash.py)

📝 This file contains a Python script that defines a Bash action class.   
📝 The purpose of the script is to run a bash command and return its output.  
📝 It uses the `asyncio` module for asynchronous execution.  
📝 The script defines input and output models for the action.  
📝 The `run` method of the action class executes the bash command and captures the stdout and stderr.  
📝 The captured output is then published using a publishing service.  
📝 The stdout and stderr are also returned as the output of the action.  
📝 The script includes a main block that manually runs the action with a sample input.  
📝 The script can be used as a standalone action or imported into other modules.  
📝 The script is organized with clear comments and documentation.  


### [`choice.py`](https://github.com/irgolic/AutoPR/blob/50cfaeeaaedc4a6529b5a363ba237dce1404ad03/./autopr/actions/choice.py)
...
### [`comment.py`](https://github.com/irgolic/AutoPR/blob/50cfaeeaaedc4a6529b5a363ba237dce1404ad03/./autopr/actions/comment.py)
...
### [`commit_and_push.py`](https://github.com/irgolic/AutoPR/blob/50cfaeeaaedc4a6529b5a363ba237dce1404ad03/./autopr/actions/commit_and_push.py)
...
### [`find_todos.py`](https://github.com/irgolic/AutoPR/blob/50cfaeeaaedc4a6529b5a363ba237dce1404ad03/./autopr/actions/find_todos.py)
...
### [`insert_content_into_text.py`](https://github.com/irgolic/AutoPR/blob/50cfaeeaaedc4a6529b5a363ba237dce1404ad03/./autopr/actions/insert_content_into_text.py)
...
### [`list_folder.py`](https://github.com/irgolic/AutoPR/blob/50cfaeeaaedc4a6529b5a363ba237dce1404ad03/./autopr/actions/list_folder.py)
...
### [`make_api_call.py`](https://github.com/irgolic/AutoPR/blob/50cfaeeaaedc4a6529b5a363ba237dce1404ad03/./autopr/actions/make_api_call.py)
...
### [`prompt.py`](https://github.com/irgolic/AutoPR/blob/50cfaeeaaedc4a6529b5a363ba237dce1404ad03/./autopr/actions/prompt.py)
...
### [`publish_issue.py`](https://github.com/irgolic/AutoPR/blob/50cfaeeaaedc4a6529b5a363ba237dce1404ad03/./autopr/actions/publish_issue.py)
...
### [`read_file.py`](https://github.com/irgolic/AutoPR/blob/50cfaeeaaedc4a6529b5a363ba237dce1404ad03/./autopr/actions/read_file.py)
...
### [`search.py`](https://github.com/irgolic/AutoPR/blob/50cfaeeaaedc4a6529b5a363ba237dce1404ad03/./autopr/actions/search.py)
...
### [`set_issue_title.py`](https://github.com/irgolic/AutoPR/blob/50cfaeeaaedc4a6529b5a363ba237dce1404ad03/./autopr/actions/set_issue_title.py)
...
### [`utils/`](https://github.com/irgolic/AutoPR/blob/50cfaeeaaedc4a6529b5a363ba237dce1404ad03/./autopr/actions/utils)
...
### [`walk_files.py`](https://github.com/irgolic/AutoPR/blob/50cfaeeaaedc4a6529b5a363ba237dce1404ad03/./autopr/actions/walk_files.py)
...
### [`write_into_file.py`](https://github.com/irgolic/AutoPR/blob/50cfaeeaaedc4a6529b5a363ba237dce1404ad03/./autopr/actions/write_into_file.py)
