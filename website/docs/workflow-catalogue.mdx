...
The following parameters are available:
- `TASK_DIFFICULTY_CHOICES`: the choices to use when asking for the difficulty of a task.
- `TASK_DIFFICULTY_PROMPT`: the prompt to use when asking for the difficulty of a task.
- `TODO_RESOLVE_PROMPT`: the prompt to use when asking for a resolution of a TODO.
- `TODO_RESOLVE_INSTRUCTIONS`: the instructions to use when asking for a resolution of a TODO.
