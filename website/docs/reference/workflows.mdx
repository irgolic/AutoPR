...
AutoPR comes with a few workflows, which you can find in [the workflow catalogue](../workflow-catalogue).

If you'd like to contribute a workflow, see [the tutorial](../tutorials/writing-a-workflow).
...
Great, now you know how to define workflows. The next step is to [define your own workflow](../tutorials/writing-a-workflow).
